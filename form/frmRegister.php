...
<form name="form1" action="insert.php" method="post">
    ...
    <label for="exampleFormControlInput1" class="form-label">ชื่อ</label>
      <input type="text" class="form-control" name="txt_name" id="txt_name" placeholder="กรุณาใส่ชื่อ">
    </div>
   ...
   <input type="date" class="form-control" id="txt_birthdate" name="txt_birthdate" placeholder="00/00/0000" date-provid="datepicker" data-date-language="th-th">
    ...
    <label for="exampleFormControlInput1" class="form-label">เบอร์โทรศัพท์</label>
      <input type="text" class="form-control" name="telephone_number" id="telephone_number" placeholder="กรุณาเบอร์โทรศัพท์">
    </div>
